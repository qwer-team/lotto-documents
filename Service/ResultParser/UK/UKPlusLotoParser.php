...
class UKPlusLotoParser extends AbstractLotoParser {
    
     protected $templateUrl = 'https://www.national-lottery.co.uk/player/plusfive/results/results.ftl?boardAddOnDraws=on';
